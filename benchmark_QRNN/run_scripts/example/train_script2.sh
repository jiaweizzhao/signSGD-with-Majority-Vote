...
cd WK_3_8_30_final
mkdir Signum_3_8_30_lr_1e-3_to_1e-4_momentum_0.5_to_0.9
cd ..
...
--save-dir ./WK_3_8_30_final/Signum_3_8_30_lr_1e-3_to_1e-4_momentum_0.5_to_0.9/ --distributed --multi_gpu --momentun_warm_up